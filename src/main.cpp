...
#if defined(NDEBUG)
# error "Bitvaluta cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Bitvaluta Signed Message:\n";
...
{
    RenameThread("bitvaluta-loadblk");
