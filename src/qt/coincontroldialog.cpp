    ...
    model(0)
{
    ...
    QAction *copyAddressAction = new QAction(tr("Copy BTV address"), this);
    QAction *copyLabelAction = new QAction(tr("Copy label"), this);
    QAction *copyAmountAction = new QAction(tr("Copy amount"), this);
             copyTransactionHashAction = new QAction(tr("Copy BTV transaction ID"), this);  // we need to enable/disable this
...
void CoinControlDialog::updateLabels(WalletModel *model, QDialog* dialog)
{
    ...
    // turn labels "red"
    l5->setStyleSheet((nBytes >= 10000) ? "color: #ff726f;" : "");               // Bytes >= 10000
    l7->setStyleSheet((fLowOutput) ? "color: #ff726f;" : "");                    // Low Output = "yes"
    l8->setStyleSheet((nChange > 0 && nChange < CENT) ? "color: #ff726f;" : ""); // Change < 0.01BTC
