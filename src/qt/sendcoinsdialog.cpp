    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a Bitvaluta address (e.g. BMw1w9irH81Fh1U6YyPisXbTTsenzn3K7h)"));
#endif
...
void SendCoinsDialog::coinControlChangeEdited(const QString & text)
{
    if (model)
    {
        ...
        {
            ui->labelCoinControlChangeLabel->setStyleSheet("QLabel{color:#ff726f;}");
            ui->labelCoinControlChangeLabel->setText(tr("WARNING: Invalid Bitvaluta address"));
        }
        else
        {
